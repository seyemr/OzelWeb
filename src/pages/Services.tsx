      ...
      <div className="container">
        ...
        <div id="servicesCarousel" className="carousel slide max-w-5xl mx-auto" data-bs-ride="carousel" data-bs-interval="8000">
            ...
            {services.map((service, index) => (
              <div key={index} className={`carousel-item ${index === 0 ? 'active' : ''}`}>
                <motion.div
                  ...
                  className={`group relative ${service.bgColor} border-2 ${service.borderColor} rounded-3xl p-8 mx-8 hover:shadow-2xl transition-all duration-500`}
                >
                  {/* Background Pattern */}
                  ...
                  <div className="relative z-10 text-center">
                    ...
                    {/* Amaç */}
                    <div className="mb-4 p-4 bg-white/60 rounded-xl border border-gray-100 text-left">
                      <h4 className="font-semibold text-blue-700 mb-2">🎯 Amaç:</h4>
                      <p className="text-sm text-gray-700">{service.amaç}</p>
                    </div>
                    
                    {/* İçerik */}
                    <div className="mb-6 p-4 bg-white/60 rounded-xl border border-gray-100 text-left">
                      <h4 className="font-semibold text-green-700 mb-2">📋 İçerik:</h4>
                      <div className="text-sm text-gray-700 whitespace-pre-line">{service.içerik}</div>
                    </div>
                    
                    {/* Action Button */}
                    <motion.button
                      onClick={() => handleServiceDetail(service.title)}
                      className="w-full bg-gradient-to-r from-blue-500 to-blue-700 text-white font-semibold py-3 px-6 rounded-xl hover:from-blue-600 hover:to-blue-800 transition-all duration-300 flex items-center justify-center gap-2 group/btn"
          ...
          <button
            ...
            data-bs-target="#servicesCarousel"
            data-bs-slide="prev"
            style={{left: '-70px', top: '50%', transform: 'translateY(-50%)', width: 'auto', height: 'auto'}}
          >
            <span 
              className="bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all duration-300 hover:scale-110" 
              aria-hidden="true"
              style={{
                display: 'flex',
                alignItems: 'center',
          ...
          <button
            ...
            data-bs-target="#servicesCarousel"
            data-bs-slide="next"
            style={{right: '-70px', top: '50%', transform: 'translateY(-50%)', width: 'auto', height: 'auto'}}
          >
            <span 
              className="bg-blue-600 text-white rounded-full shadow-lg hover:bg-blue-700 transition-all duration-300 hover:scale-110" 
              aria-hidden="true"
